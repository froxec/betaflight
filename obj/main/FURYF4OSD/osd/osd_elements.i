...
# 168 "./src/main/osd/osd_elements.c" 2
    ...
    case OSD_ELEMENT_TYPE_4:
        {
            ...
            *buff++ = 0x1F;
            if ((stateFlags & (GPS_FIX_EVER))) {
                OLC_LatLon location;
                location.lat = (double)gpsSol.llh.lat / 10000000L;
                location.lon = (double)gpsSol.llh.lon / 10000000L;
                OLC_Encode(&location, 11, buff, 32 - 3);
            } else {
                memset(buff, 0x2D, 11 + 1);
                buff[8] = '+';
                buff[11 + 1] = '\0';
            }
            break;
