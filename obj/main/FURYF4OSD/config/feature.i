...
const featureConfig_t pgResetTemplate_featureConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .enabledFeatures = FEATURE_OSD | FEATURE_RX_SERIAL | FEATURE_ANTI_GRAVITY | FEATURE_AIRMODE, }
