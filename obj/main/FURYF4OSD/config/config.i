...
0
# 117 "./src/main/config/config.c"
, .cpu_overclock = 0, .powerOnArmingGraceTime = 5, .boardIdentifier = "FY4O", .hseMhz = (8000000/1000000U), .configurationState = CONFIGURATION_STATE_DEFAULTS_BARE, .enableStickArming = 
# 117 "./src/main/config/config.c" 3 4
0
# 117 "./src/main/config/config.c"
, }
