...
uint8_t usbd_cdc_DataIn (void *pdev, uint8_t epnum)
{
    ...
    if (USB_Tx_State == 1)
    {
        if (APP_Rx_length == 0)
        {
            ...
            DCD_EP_Tx(pdev, 0x81, (uint8_t*)&APP_Rx_Buffer[APP_Rx_ptr_out], USB_Tx_length);


            APP_Rx_ptr_out = (APP_Rx_ptr_out + USB_Tx_length) % 2048;
    ...
    if (USB_Tx_State == 2) {
        ...
        DCD_EP_Tx(pdev, 0x81, 0, 0);

        USB_Tx_State = 0;
    }
    return USBD_OK;
}
# 668 "./lib/main/STM32_USB_Device_Library/Class/cdc/src/usbd_cdc_core.c"
uint8_t usbd_cdc_DataOut (void *pdev, uint8_t epnum)
{
  uint16_t USB_Rx_Cnt;
...
# 695 "./lib/main/STM32_USB_Device_Library/Class/cdc/src/usbd_cdc_core.c"
uint8_t usbd_cdc_SOF (void *pdev)
{
...
# 771 "./lib/main/STM32_USB_Device_Library/Class/cdc/src/usbd_cdc_core.c"
static uint8_t *USBD_cdc_GetCfgDesc (uint8_t speed, uint16_t *length)
{
    (void)speed;
