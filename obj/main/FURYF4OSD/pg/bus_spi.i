...
extern void pgResetFn_spiPinConfig(spiPinConfig_t *); spiPinConfig_t spiPinConfig_SystemArray[3]; spiPinConfig_t spiPinConfig_CopyArray[3]; uint32_t spiPinConfig_fnv_hash; extern const pgRegistry_t spiPinConfig_Registry; const pgRegistry_t spiPinConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 520 | (1 << 12), .length = 3, .size = (sizeof(spiPinConfig_t) * 3) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&spiPinConfig_SystemArray, .fnv_hash = &spiPinConfig_fnv_hash, .copy = (uint8_t*)&spiPinConfig_CopyArray, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_spiPinConfig}, };
