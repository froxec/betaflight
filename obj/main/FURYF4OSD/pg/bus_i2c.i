...
extern void pgResetFn_i2cConfig(i2cConfig_t *); i2cConfig_t i2cConfig_SystemArray[3]; i2cConfig_t i2cConfig_CopyArray[3]; uint32_t i2cConfig_fnv_hash; extern const pgRegistry_t i2cConfig_Registry; const pgRegistry_t i2cConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 518 | (1 << 12), .length = 3, .size = (sizeof(i2cConfig_t) * 3) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&i2cConfig_SystemArray, .fnv_hash = &i2cConfig_fnv_hash, .copy = (uint8_t*)&i2cConfig_CopyArray, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_i2cConfig}, };
