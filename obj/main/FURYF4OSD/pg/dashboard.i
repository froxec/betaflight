...
extern const dashboardConfig_t pgResetTemplate_dashboardConfig; dashboardConfig_t dashboardConfig_System; dashboardConfig_t dashboardConfig_Copy; uint32_t dashboardConfig_fnv_hash; extern const pgRegistry_t dashboardConfig_Registry; const pgRegistry_t dashboardConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 519 | (0 << 12), .length = 1, .size = sizeof(dashboardConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&dashboardConfig_System, .fnv_hash = &dashboardConfig_fnv_hash, .copy = (uint8_t*)&dashboardConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_dashboardConfig}, };
