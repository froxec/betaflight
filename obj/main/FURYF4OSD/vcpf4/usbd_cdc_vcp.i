...
# 32 "./src/main/vcpf4/usbd_cdc_vcp.c" 2
...
# 83 "./src/main/vcpf4/usbd_cdc_vcp.c"
static uint16_t VCP_Init(void)
{
    bDeviceState = CONFIGURED;
    ctrlLineStateCb = 
# 86 "./src/main/vcpf4/usbd_cdc_vcp.c" 3 4
                     ((void *)0)
# 86 "./src/main/vcpf4/usbd_cdc_vcp.c"
                         ;
    baudRateCb = 
# 87 "./src/main/vcpf4/usbd_cdc_vcp.c" 3 4
                ((void *)0)
# 87 "./src/main/vcpf4/usbd_cdc_vcp.c"
                    ;
    return USBD_OK;
}
...
# 119 "./src/main/vcpf4/usbd_cdc_vcp.c"
static uint16_t VCP_Ctrl(uint32_t Cmd, uint8_t* Buf, uint32_t Len)
{
...
uint32_t CDC_Send_FreeBytes(void)
{
    return 2048 - CDC_Receive_BytesAvailable();
}
...
static uint16_t VCP_DataTx(const uint8_t* Buf, uint32_t Len)
{
    ...
    for (uint32_t i = 0; i < Len; i++) {
        ...
        while (((APP_Rx_ptr_in + 1) % 2048) == APP_Rx_ptr_out) {
            delay(1);
        }
...
uint32_t CDC_Receive_BytesAvailable(void)
{
    ...
    return (APP_Tx_ptr_in + 2048 - APP_Tx_ptr_out) % 2048;
}
