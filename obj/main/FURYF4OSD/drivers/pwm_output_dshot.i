...
# 274 "./src/main/drivers/pwm_output_dshot.c" 3 4
   _Bool 
...
# 274 "./src/main/drivers/pwm_output_dshot.c"
    ...
    if (useBurstDshot) {
        ...
        if (owner->owner == OWNER_TIMUP && owner->resourceIndex == timerGetTIMNumber(timerHardware->tim)) {
            dmaIsConfigured = 
# 279 "./src/main/drivers/pwm_output_dshot.c" 3 4
                             1
# 279 "./src/main/drivers/pwm_output_dshot.c"
                                 ;
        } else if (!dmaAllocate(dmaIdentifier, OWNER_TIMUP, timerGetTIMNumber(timerHardware->tim))) {
            return 
# 281 "./src/main/drivers/pwm_output_dshot.c" 3 4
                  0
# 281 "./src/main/drivers/pwm_output_dshot.c"
                       ;
        }
    } else

    {
        if (!dmaAllocate(dmaIdentifier, OWNER_MOTOR, (reorderedMotorIndex + 1))) {
            return 
# 287 "./src/main/drivers/pwm_output_dshot.c" 3 4
                  0
# 287 "./src/main/drivers/pwm_output_dshot.c"
                       ;
        }
    }
    ...
    const 
# 299 "./src/main/drivers/pwm_output_dshot.c" 3 4
         _Bool 
# 299 "./src/main/drivers/pwm_output_dshot.c"
    ...
    if (useBurstDshot) {
        if (!dmaIsConfigured) {
            dmaSetHandler(dmaIdentifier, motor_DMA_IRQHandler, (((((2)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0), motor->index);
        }
    } else
    ...
    motor->configured = 
# 466 "./src/main/drivers/pwm_output_dshot.c" 3 4
                       1
# 466 "./src/main/drivers/pwm_output_dshot.c"
                           ;

    return 
# 468 "./src/main/drivers/pwm_output_dshot.c" 3 4
          1
# 468 "./src/main/drivers/pwm_output_dshot.c"
              ;
}
