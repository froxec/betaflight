...
# 417 "./src/main/drivers/bus_spi.c" 3 4
                                     ((void *)0)
# 417 "./src/main/drivers/bus_spi.c"
                                         ;
...
# 425 "./src/main/drivers/bus_spi.c" 3 4
       _Bool 
# 425 "./src/main/drivers/bus_spi.c"
        ...
        if (bus->initSegment) {
            spiInternalInitStream(dev, 
# 431 "./src/main/drivers/bus_spi.c" 3 4
                                      0
# 431 "./src/main/drivers/bus_spi.c"
                                           );
            bus->initSegment = 
# 432 "./src/main/drivers/bus_spi.c" 3 4
                              0
# 432 "./src/main/drivers/bus_spi.c"
                                   ;
        }
        ...
        spiInternalInitStream(dev, 
# 444 "./src/main/drivers/bus_spi.c" 3 4
                                  1
# 444 "./src/main/drivers/bus_spi.c"
                                      );
    }
}
...
# 481 "./src/main/drivers/bus_spi.c"
    spiIrqHandler(dev);
}
...
# 508 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 508 "./src/main/drivers/bus_spi.c"
    spiSetBusInstance(extDevice_t *dev, uint32_t device)
{
    if ((device == 0) || (device > 3)) {
        return 
# 511 "./src/main/drivers/bus_spi.c" 3 4
              0
# 511 "./src/main/drivers/bus_spi.c"
                   ;
    }
    ...
    dev->useDMA = 
# 517 "./src/main/drivers/bus_spi.c" 3 4
                 1
# 517 "./src/main/drivers/bus_spi.c"
                     ;
...
# 529 "./src/main/drivers/bus_spi.c" 3 4
                                      ((void *)0)
# 529 "./src/main/drivers/bus_spi.c"
                                          ) {
        return 
# 530 "./src/main/drivers/bus_spi.c" 3 4
              0
# 530 "./src/main/drivers/bus_spi.c"
                   ;
    }
...
void spiInitBusDMA()
{
    ...
    const 
# 551 "./src/main/drivers/bus_spi.c" 3 4
         _Bool 
# 551 "./src/main/drivers/bus_spi.c"
              dshotBitbangActive = isDshotBitbangActive(&motorConfig()->dev);
    ...
    for (device = 0; device < 3; device++) {
        ...
        for (uint8_t opt = txDmaoptMin; opt <= txDmaoptMax; opt++) {
            ...
            if (dmaTxChannelSpec) {
                ...
                if (dshotBitbangActive && (((((dmaTxIdentifier)-1) / 8) + 1) == 2)) {
        ...
        for (uint8_t opt = rxDmaoptMin; opt <= rxDmaoptMax; opt++) {
            ...
            if (dmaRxChannelSpec) {
                ...
                if (dshotBitbangActive && (((((dmaRxIdentifier)-1) / 8) + 1) == 2)) {
        ...
        if (dmaTxIdentifier && dmaRxIdentifier) {
            ...
            dmaSetHandler(dmaRxIdentifier, spiRxIrqHandler, (((((0)<<(4-(7-(((uint32_t)0x500)>>8))))|((0)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0), 0);

            bus->useDMA = 
# 645 "./src/main/drivers/bus_spi.c" 3 4
                         1
# 645 "./src/main/drivers/bus_spi.c"
                             ;
...
# 650 "./src/main/drivers/bus_spi.c"
            ...
            dmaSetHandler(dmaTxIdentifier, spiTxIrqHandler, (((((0)<<(4-(7-(((uint32_t)0x500)>>8))))|((0)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0), 0);

            bus->useDMA = 
# 659 "./src/main/drivers/bus_spi.c" 3 4
                         1
# 659 "./src/main/drivers/bus_spi.c"
                             ;

        } else {

            bus->dmaRx = (dmaChannelDescriptor_t *)
# 663 "./src/main/drivers/bus_spi.c" 3 4
                                                  ((void *)0)
# 663 "./src/main/drivers/bus_spi.c"
                                                      ;
...
void spiSetClkPhasePolarity(const extDevice_t *dev, 
# 675 "./src/main/drivers/bus_spi.c" 3 4
                                                   _Bool 
# 675 "./src/main/drivers/bus_spi.c"
                                                        leadingEdge)
{
...
void spiDmaEnable(const extDevice_t *dev, 
# 681 "./src/main/drivers/bus_spi.c" 3 4
                                         _Bool 
# 681 "./src/main/drivers/bus_spi.c"
                                              enable)
{
...
# 692 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 692 "./src/main/drivers/bus_spi.c"
    spiUseMOSI_DMA(const extDevice_t *dev)
{
...
void spiSequence(const extDevice_t *dev, busSegment_t *segments)
{
    ...
    for ( uint8_t __basepri_save __attribute__ ((__cleanup__ (__basepriRestoreMem), __unused__)) = __get_BASEPRI(), __ToDo = __basepriSetMemRetVal((((((0)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0)); __ToDo ; __ToDo = 0 ) {
        if (spiIsBusy(dev)) {
            ...
            if (endCmpSegment) {
                while (
# 732 "./src/main/drivers/bus_spi.c" 3 4
                      1
# 732 "./src/main/drivers/bus_spi.c"
                          ) {
...
# 744 "./src/main/drivers/bus_spi.c" 3 4
                                                    ((void *)0)
# 744 "./src/main/drivers/bus_spi.c"
                                                        ) {
