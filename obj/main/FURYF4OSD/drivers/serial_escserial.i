...
extern const escSerialConfig_t pgResetTemplate_escSerialConfig; escSerialConfig_t escSerialConfig_System; escSerialConfig_t escSerialConfig_Copy; uint32_t escSerialConfig_fnv_hash; extern const pgRegistry_t escSerialConfig_Registry; const pgRegistry_t escSerialConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 521 | (0 << 12), .length = 1, .size = sizeof(escSerialConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&escSerialConfig_System, .fnv_hash = &escSerialConfig_fnv_hash, .copy = (uint8_t*)&escSerialConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_escSerialConfig}, };





const escSerialConfig_t pgResetTemplate_escSerialConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .ioTag = ((ioTag_t)((((2) + 1) << 4) | (9))), }
