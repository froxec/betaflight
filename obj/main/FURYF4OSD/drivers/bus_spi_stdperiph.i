...
# 37 "./src/main/drivers/bus_spi_stdperiph.c" 2
...
# 38 "./src/main/drivers/bus_spi_stdperiph.c" 2
...
# 39 "./src/main/drivers/bus_spi_stdperiph.c" 2
...
void spiInternalResetDescriptors(busDevice_t *bus)
{
    ...
    initTx->DMA_DIR = ((uint32_t)0x00000040);
    initTx->DMA_Mode = ((uint32_t)0x00000000);
    initTx->DMA_PeripheralBaseAddr = (uint32_t)&bus->busType_u.spi.instance->DR;
    initTx->DMA_Priority = ((uint32_t)0x00000000);
    initTx->DMA_PeripheralInc = ((uint32_t)0x00000000);
    initTx->DMA_PeripheralDataSize = ((uint32_t)0x00000000);
    initTx->DMA_MemoryDataSize = ((uint32_t)0x00000000);
    ...
    if (bus->dmaRx) {
        ...
        initRx->DMA_DIR = ((uint32_t)0x00000000);
        initRx->DMA_Mode = ((uint32_t)0x00000000);
        initRx->DMA_PeripheralBaseAddr = (uint32_t)&bus->busType_u.spi.instance->DR;
        initRx->DMA_Priority = ((uint32_t)0x00000000);
        initRx->DMA_PeripheralInc = ((uint32_t)0x00000000);
        initRx->DMA_PeripheralDataSize = ((uint32_t)0x00000000);
    }
}
...
static 
# 144 "./src/main/drivers/bus_spi_stdperiph.c" 3 4
      _Bool 
# 144 "./src/main/drivers/bus_spi_stdperiph.c"
           spiInternalReadWriteBufPolled(SPI_TypeDef *instance, const uint8_t *txData, uint8_t *rxData, int len)
{
    ...
    return 
# 160 "./src/main/drivers/bus_spi_stdperiph.c" 3 4
          1
# 160 "./src/main/drivers/bus_spi_stdperiph.c"
              ;
}

void spiInternalInitStream(const extDevice_t *dev, 
# 163 "./src/main/drivers/bus_spi_stdperiph.c" 3 4
                                                  _Bool 
# 163 "./src/main/drivers/bus_spi_stdperiph.c"
                                                       preInit)
{
    ...
    if (txData) {
        ...
        initTx->DMA_MemoryInc = ((uint32_t)0x00000400);
    } else {
        dummyTxByte = 0xff;
        initTx->DMA_Memory0BaseAddr = (uint32_t)&dummyTxByte;
        initTx->DMA_MemoryInc = ((uint32_t)0x00000000);
    }
    ...
    if (dev->bus->dmaRx) {
        ...
        if (rxData) {
            ...
            initRx->DMA_MemoryInc = ((uint32_t)0x00000400);
        } else {
            initRx->DMA_Memory0BaseAddr = (uint32_t)&dummyRxByte;
            initRx->DMA_MemoryInc = ((uint32_t)0x00000000);
        }

        if ((initRx->DMA_Memory0BaseAddr & 0x1) || (len & 0x1)) {
            initRx->DMA_MemoryDataSize = ((uint32_t)0x00000000);
        } else {
            initRx->DMA_MemoryDataSize = ((uint32_t)0x00002000);
        }
...
void spiInternalStartDMA(const extDevice_t *dev)
{
    ...
    if (dmaRx) {
        ...
        DMA_ITConfig(streamRegsRx, ((uint32_t)0x00000010), ENABLE);


        DMA_Init(streamRegsTx, dev->bus->initTx);
        DMA_Init(streamRegsRx, dev->bus->initRx);
# 252 "./src/main/drivers/bus_spi_stdperiph.c"
        DMA_Cmd(streamRegsTx, ENABLE);
        DMA_Cmd(streamRegsRx, ENABLE);


        SPI_I2S_DMACmd(dev->bus->busType_u.spi.instance, ((uint16_t)0x0002) | ((uint16_t)0x0001), ENABLE);
    } else {
        ...
        DMA_ITConfig(streamRegsTx, ((uint32_t)0x00000010), ENABLE);


        DMA_Init(streamRegsTx, dev->bus->initTx);
# 280 "./src/main/drivers/bus_spi_stdperiph.c"
        DMA_Cmd(streamRegsTx, ENABLE);


        SPI_I2S_DMACmd(dev->bus->busType_u.spi.instance, ((uint16_t)0x0002), ENABLE);
    }
}
...
void spiInternalStopDMA (const extDevice_t *dev)
{
    ...
    if (dmaRx) {
        ...
        SPI_I2S_DMACmd(instance, ((uint16_t)0x0002) | ((uint16_t)0x0001), DISABLE);
    } else {

        while (SPI_I2S_GetFlagStatus(instance, ((uint16_t)0x0080)));


        while (SPI_I2S_GetFlagStatus(instance, ((uint16_t)0x0001))) {
            instance->DR;
        }
        ...
        SPI_I2S_DMACmd(instance, ((uint16_t)0x0002), DISABLE);
    }
}
...
# 324 "./src/main/drivers/bus_spi_stdperiph.c" 3 4
   _Bool 
# 324 "./src/main/drivers/bus_spi_stdperiph.c"
        dmaSafe = dev->useDMA;
    uint32_t xferLen = 0;
    uint32_t segmentCount = 0;

    dev->bus->initSegment = 
# 328 "./src/main/drivers/bus_spi_stdperiph.c" 3 4
                           1
# 328 "./src/main/drivers/bus_spi_stdperiph.c"
                               ;
    ...
    for (busSegment_t *checkSegment = (busSegment_t *)bus->curSegment; checkSegment->len; checkSegment++) {
        ...
        if (((checkSegment->u.buffers.rxData) && ((((uint32_t)checkSegment->u.buffers.rxData & 0xffff0000) == 0x10000000) || (bus->dmaRx == (dmaChannelDescriptor_t *)
# 357 "./src/main/drivers/bus_spi_stdperiph.c" 3 4
                                                                                                                                    ((void *)0)
# 357 "./src/main/drivers/bus_spi_stdperiph.c"
                                                                                                                                        ))) ||
            ((checkSegment->u.buffers.txData) && (((uint32_t)checkSegment->u.buffers.txData & 0xffff0000) == 0x10000000))) {
            dmaSafe = 
# 359 "./src/main/drivers/bus_spi_stdperiph.c" 3 4
                     0
# 359 "./src/main/drivers/bus_spi_stdperiph.c"
                          ;
            break;
        }
...
# 370 "./src/main/drivers/bus_spi_stdperiph.c" 3 4
                                  0
# 370 "./src/main/drivers/bus_spi_stdperiph.c"
                                       );
...
# 378 "./src/main/drivers/bus_spi_stdperiph.c" 3 4
                                   ((void *)0)
# 378 "./src/main/drivers/bus_spi_stdperiph.c"
                                       ;
...
# 425 "./src/main/drivers/bus_spi_stdperiph.c" 3 4
                                    ((void *)0)
# 425 "./src/main/drivers/bus_spi_stdperiph.c"
                                        ;
