...
# 343 "./src/main/drivers/max7456.c"
    ...
    IOConfigGPIO(dev->busType_u.spi.csnPin, ((GPIO_Mode_OUT) | ((GPIO_Fast_Speed) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
    ...
    if (osdm != 0x1B) {
        IOConfigGPIO(dev->busType_u.spi.csnPin, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_UP) << 5)));
