...
# 176 "./src/main/drivers/display_ug2864hsweg01.c"
           i2c_OLED_send_cmd(const extDevice_t *dev, uint8_t command)
{
...
# 181 "./src/main/drivers/display_ug2864hsweg01.c"
           i2c_OLED_send_cmdarray(const extDevice_t *dev, const uint8_t *commands, size_t len)
{
...
# 192 "./src/main/drivers/display_ug2864hsweg01.c"
           i2c_OLED_send_byte(const extDevice_t *dev, uint8_t val)
{
...
void i2c_OLED_clear_display_quick(const extDevice_t *dev)
{
    ...
    i2c_OLED_send_cmdarray(dev, i2c_OLED_cmd_clear_display_quick, (sizeof(i2c_OLED_cmd_clear_display_quick) / sizeof((i2c_OLED_cmd_clear_display_quick)[0])));

    for (uint16_t i = 0; i < 1024; i++) {
        i2c_OLED_send_byte(dev, 0x00);
    }
}
...
void i2c_OLED_clear_display(const extDevice_t *dev)
{
    ...
    i2c_OLED_send_cmdarray(dev, i2c_OLED_cmd_clear_display_pre, (sizeof(i2c_OLED_cmd_clear_display_pre) / sizeof((i2c_OLED_cmd_clear_display_pre)[0])));
    ...
    i2c_OLED_send_cmdarray(dev, i2c_OLED_cmd_clear_display_post, (sizeof(i2c_OLED_cmd_clear_display_post) / sizeof((i2c_OLED_cmd_clear_display_post)[0])));
}
...
void i2c_OLED_set_xy(const extDevice_t *dev, uint8_t col, uint8_t row)
{
    ...
    i2c_OLED_send_cmdarray(dev, i2c_OLED_cmd_set_xy, (sizeof(i2c_OLED_cmd_set_xy) / sizeof((i2c_OLED_cmd_set_xy)[0])));
}
...
void i2c_OLED_send_char(const extDevice_t *dev, unsigned char ascii)
{
    ...
    i2c_OLED_send_byte(dev, CHAR_FORMAT);
}
...
# 281 "./src/main/drivers/display_ug2864hsweg01.c"
    ...
    i2c_OLED_send_cmdarray(dev, i2c_OLED_cmd_init, (sizeof(i2c_OLED_cmd_init) / sizeof((i2c_OLED_cmd_init)[0])));
