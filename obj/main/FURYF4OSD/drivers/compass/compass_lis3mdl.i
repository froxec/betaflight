...
# 107 "./src/main/drivers/compass/compass_lis3mdl.c"
    ...
    if (pendingRead) {
        busReadRegisterBufferStart(dev, 0x28, buf, sizeof(buf));

        pendingRead = 
# 114 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
                     0
# 114 "./src/main/drivers/compass/compass_lis3mdl.c"
                          ;
        return 
...
# 115 "./src/main/drivers/compass/compass_lis3mdl.c"
    ...
    pendingRead = 
# 122 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
                 1
# 122 "./src/main/drivers/compass/compass_lis3mdl.c"
                     ;

    return 
# 124 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
          1
# 124 "./src/main/drivers/compass/compass_lis3mdl.c"
              ;
}

static 
# 127 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
      _Bool 
# 127 "./src/main/drivers/compass/compass_lis3mdl.c"
           lis3mdlInit(magDev_t *mag)
{
    ...
    busWriteRegister(dev, 0x21, 0x00);
    busWriteRegister(dev, 0x20, 0x80 | 0x60 | 0x1C);
    busWriteRegister(dev, 0x24, 0x40);
    busWriteRegister(dev, 0x23, 0x0C);
    busWriteRegister(dev, 0x22, 0x00);

    delay(100);

    return 
# 141 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
          1
# 141 "./src/main/drivers/compass/compass_lis3mdl.c"
              ;
}


# 144 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
_Bool 
# 144 "./src/main/drivers/compass/compass_lis3mdl.c"
...
# 154 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
   _Bool 
# 154 "./src/main/drivers/compass/compass_lis3mdl.c"
        ack = busReadRegisterBuffer(&mag->dev, 0x0F, &sig, 1);

    if (!ack || sig != 0x3D) {
        return 
# 157 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
              0
# 157 "./src/main/drivers/compass/compass_lis3mdl.c"
                   ;
    }
    ...
    return 
# 163 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
          1
# 163 "./src/main/drivers/compass/compass_lis3mdl.c"
              ;
}
