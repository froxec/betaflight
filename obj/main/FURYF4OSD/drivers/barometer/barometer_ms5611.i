...
{
# 75 "./src/main/drivers/barometer/barometer_ms5611.c"
    (void)(dev);
...
{
    busRawWriteRegister(dev, 0x1E, 1);
...
static uint16_t ms5611Prom(const extDevice_t *dev, int8_t coef_num)
{
    ...
    busRawReadRegisterBuffer(dev, 0xA0 + coef_num * 2, rxbuf, 2);
...
# 113 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
   _Bool 
# 113 "./src/main/drivers/barometer/barometer_ms5611.c"
        blankEeprom = 
# 113 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
                      1
# 113 "./src/main/drivers/barometer/barometer_ms5611.c"
...
{
    busRawReadRegisterBufferStart(dev, 0x00, sensor_data, 3);
}

static void ms5611StartUT(baroDev_t *baro)
{
    busRawWriteRegisterStart(&baro->dev, 0x40 + 0x10 + ms5611_osr, 1);
}

static 
# 146 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
      _Bool 
# 146 "./src/main/drivers/barometer/barometer_ms5611.c"
           ms5611ReadUT(baroDev_t *baro)
{
    if (busBusy(&baro->dev, 
# 148 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
                           ((void *)0)
# 148 "./src/main/drivers/barometer/barometer_ms5611.c"
                               )) {
        return 
# 149 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
              0
# 149 "./src/main/drivers/barometer/barometer_ms5611.c"
                   ;
    }
    ...
    return 
# 154 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
          1
# 154 "./src/main/drivers/barometer/barometer_ms5611.c"
              ;
}

static 
# 157 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
      _Bool 
# 157 "./src/main/drivers/barometer/barometer_ms5611.c"
           ms5611GetUT(baroDev_t *baro)
{
    if (busBusy(&baro->dev, 
# 159 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
                           ((void *)0)
# 159 "./src/main/drivers/barometer/barometer_ms5611.c"
                               )) {
        return 
# 160 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
              0
# 160 "./src/main/drivers/barometer/barometer_ms5611.c"
                   ;
    }
    ...
    return 
# 165 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
          1
# 165 "./src/main/drivers/barometer/barometer_ms5611.c"
              ;
}

static void ms5611StartUP(baroDev_t *baro)
{
    busRawWriteRegisterStart(&baro->dev, 0x40 + 0x00 + ms5611_osr, 1);
}
...
{
    if (busBusy(&baro->dev, 
# 175 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
                           ((void *)0)
# 175 "./src/main/drivers/barometer/barometer_ms5611.c"
                               )) {
        return 
# 176 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
              0
# 176 "./src/main/drivers/barometer/barometer_ms5611.c"
                   ;
    }
    ...
    return 
# 181 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
          1
# 181 "./src/main/drivers/barometer/barometer_ms5611.c"
              ;
}

static 
# 184 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
      _Bool 
# 184 "./src/main/drivers/barometer/barometer_ms5611.c"
           ms5611GetUP(baroDev_t *baro)
{
    if (busBusy(&baro->dev, 
# 186 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
                           ((void *)0)
# 186 "./src/main/drivers/barometer/barometer_ms5611.c"
                               )) {
        return 
# 187 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
              0
# 187 "./src/main/drivers/barometer/barometer_ms5611.c"
                   ;
    }
    ...
    return 
# 192 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
          1
# 192 "./src/main/drivers/barometer/barometer_ms5611.c"
              ;
}
...
# 227 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
_Bool 
# 227 "./src/main/drivers/barometer/barometer_ms5611.c"
    ms5611Detect(baroDev_t *baro)
{
    uint8_t sig;
    int i;
...
# 231 "./src/main/drivers/barometer/barometer_ms5611.c"
    ...
    if ((dev->bus->busType == BUS_TYPE_I2C) && (dev->busType_u.i2c.address == 0)) {
        ...
        defaultAddressApplied = 
# 242 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
                               1
# 242 "./src/main/drivers/barometer/barometer_ms5611.c"
                                   ;
    }

    if (!busRawReadRegisterBuffer(dev, 0xA0, &sig, 1) || sig == 0xFF) {
        goto fail;
    }
    ...
    return 
# 273 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
          1
# 273 "./src/main/drivers/barometer/barometer_ms5611.c"
              ;
...
fail:;
    ...
    return 
# 282 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
          0
# 282 "./src/main/drivers/barometer/barometer_ms5611.c"
               ;
}
