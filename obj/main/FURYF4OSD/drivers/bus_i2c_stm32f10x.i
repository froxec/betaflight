...
# 49 "./src/main/drivers/bus_i2c_stm32f10x.c"
static void i2c_er_handler(I2CDevice device);
static void i2c_ev_handler(I2CDevice device);
static void i2cUnstick(IO_t scl, IO_t sda);
# 60 "./src/main/drivers/bus_i2c_stm32f10x.c"
...
# 126 "./src/main/drivers/bus_i2c_stm32f10x.c"
};
...
static 
# 158 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
      _Bool 
# 158 "./src/main/drivers/bus_i2c_stm32f10x.c"
           i2cHandleHardwareFailure(I2CDevice device)
{
    ...
    i2cInit(device);
    return 
# 163 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
          0
# 163 "./src/main/drivers/bus_i2c_stm32f10x.c"
               ;
}


# 166 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
_Bool 
# 166 "./src/main/drivers/bus_i2c_stm32f10x.c"
    i2cWriteBuffer(I2CDevice device, uint8_t addr_, uint8_t reg_, uint8_t len_, uint8_t *data)
{
    if (device == I2CINVALID || device >= 3) {
        return 
# 169 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
              0
# 169 "./src/main/drivers/bus_i2c_stm32f10x.c"
                   ;
    }
...
# 175 "./src/main/drivers/bus_i2c_stm32f10x.c"
    ...
    if (state->busy) {
        return 
# 180 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
              0
# 180 "./src/main/drivers/bus_i2c_stm32f10x.c"
                   ;
    }
    ...
    if (!(I2Cx->CR2 & ((uint16_t)0x0200))) {
        if (!(I2Cx->CR1 & ((uint16_t)0x0100))) {
            while (I2Cx->CR1 & ((uint16_t)0x0200)) {
                if (cmpTimeUs(microsISR(), timeoutStartUs) >= 10000) {
...
# 234 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
_Bool 
# 234 "./src/main/drivers/bus_i2c_stm32f10x.c"
...
# 239 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
_Bool 
# 239 "./src/main/drivers/bus_i2c_stm32f10x.c"
    i2cReadBuffer(I2CDevice device, uint8_t addr_, uint8_t reg_, uint8_t len, uint8_t* buf)
{
    if (device == I2CINVALID || device >= 3) {
        return 
# 242 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
              0
# 242 "./src/main/drivers/bus_i2c_stm32f10x.c"
                   ;
    }
    ...
    if (!I2Cx) {
        return 
# 247 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
              0
# 247 "./src/main/drivers/bus_i2c_stm32f10x.c"
                   ;
    }
    ...
    if (state->busy) {
        return 
# 252 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
              0
# 252 "./src/main/drivers/bus_i2c_stm32f10x.c"
                   ;
    }
...
# 265 "./src/main/drivers/bus_i2c_stm32f10x.c"
    ...
    return 
# 279 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
          1
# 279 "./src/main/drivers/bus_i2c_stm32f10x.c"
              ;
}


# 282 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
_Bool 
# 282 "./src/main/drivers/bus_i2c_stm32f10x.c"
...
static void i2c_er_handler(I2CDevice device) {
    ...
    if (SR1Register & (((uint16_t)0x0100) | ((uint16_t)0x0200) | ((uint16_t)0x0400) | ((uint16_t)0x0800)))
        state->error = 
# 297 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
                      1
# 297 "./src/main/drivers/bus_i2c_stm32f10x.c"
                          ;
